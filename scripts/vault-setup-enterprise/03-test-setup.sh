...
echo ""
echo "Next steps:"
echo "  1. Start Vault Agent in a new terminal:"
echo "     vault agent -config=configs/vault-agent/vault-agent-enterprise-dev.hcl"
echo ""
echo "  2. Test file encryption:"
echo "     echo 'Hello, Vault!' > test.txt"
echo "     ./bin/file-encryptor encrypt -i test.txt -o test.enc -c configs/examples/example-enterprise.hcl"
echo ""
echo "  3. Test file decryption:"
echo "     ./bin/file-encryptor decrypt -i test.enc -k test.key -o decrypted.txt -c configs/examples/example-enterprise.hcl"
echo ""
